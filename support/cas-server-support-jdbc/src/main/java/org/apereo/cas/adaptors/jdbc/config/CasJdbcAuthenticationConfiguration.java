...
import org.apereo.cas.adaptors.jdbc.StoredProcedureDatabaseAuthenticationHandler;
...
public class CasJdbcAuthenticationConfiguration {
    ...
    private PasswordPolicyConfiguration storedProcedurePasswordPolicyConfiguration;
    ...
    public Collection<AuthenticationHandler> jdbcAuthenticationHandlers() {
        ...
        jdbc.getStore().forEach(b ->handlers.add(storedProcedureDatabaseAuthenticationHandler(b)));
    ...
    private AuthenticationHandler storedProcedureDatabaseAuthenticationHandler(final JdbcAuthenticationProperties.Store b) {
        final Map<String, String> attributes = Beans.transformPrincipalAttributesListIntoMap(b.getPrincipalAttributeList());
        LOGGER.debug("Created storeProcedure and mapped principal attributes [{}] for [{}]...", attributes, b.getUrl());
        final String myagent = WebUtils.getHttpServletRequestUserAgent();

        final StoredProcedureDatabaseAuthenticationHandler h = new StoredProcedureDatabaseAuthenticationHandler(b.getName(), 
                servicesManager,
                jdbcPrincipalFactory(), b.getOrder(),
                Beans.newDataSource(b), b.getProcName(), "Username", "Password",
                b.getClientip(), b.getClientos(), b.getClientbrowser(), 
                myagent, //b.getUseragent(), 
                b.getClientcountry(),
                b.getClientarea(),
                b.getRetStr());
        ...
        if (storedProcedurePasswordPolicyConfiguration != null) {
            h.setPasswordPolicyConfiguration(storedProcedurePasswordPolicyConfiguration);
        }
        ...
        LOGGER.debug("anson Created storeProcedure authentication handler [{}] to handle database url at [{}]", h.getName(), b.getUrl());
        return h;
    }
